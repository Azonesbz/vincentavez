...
const ScrollTopButton = () => {
    ...
    return (
        <button className={`p-2 bottom-5 right-5 lg:bottom-20 lg:right-20 rounded-full bg-[#071952] duration-500 ${scrollY > window.innerHeight - scrollY ? "fixed opacity-100" : "opacity-0"}`} onClick={() => window.scrollTo(0, 0)}>
