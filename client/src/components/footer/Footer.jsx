    ...
    return (
        <>
            ...
            <footer className="container py-10 ">
                ...
                <footer className="border-t-[1px] border-stone-400 mt-5 pt-5 flex justify-center min-w-screen">
                    <i className="text-sm text-stone-500 mx-auto">Copyright © 2023 Azones Inc. All Rights Reserved.</i>
                </footer>
            </footer>
        </>
    )
